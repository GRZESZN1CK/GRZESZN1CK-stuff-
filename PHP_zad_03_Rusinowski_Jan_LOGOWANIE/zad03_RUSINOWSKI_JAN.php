...
$login_poprawny = "admin";
$haslo_poprawne = "admin";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["login"]) && isset($_POST["haslo"])) { //JEŚLI POST, NIDZIAŁO WYPRÓBOPWAC GET
    $login = $_POST["login"];
    $haslo = $_POST["haslo"];

    if ($login === $login_poprawny && $haslo === $haslo_poprawne) {
